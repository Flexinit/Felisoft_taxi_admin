...
public class CanceledRideFragment extends MainBaseFragment implements IAdapterItemClickListener {
    ...
    @BindView(R.id.rv_canceled_rides)
    RecyclerView canceledRidesRecyclerView;

    @Override
    protected void initViewsForFragment(View view) {

        sectionAdapter = new SectionedRecyclerViewAdapter();
        canceledRidesRecyclerView.setLayoutManager(new LinearLayoutManager(getmContext()));
        canceledRidesRecyclerView.setAdapter(sectionAdapter);

    }

    @Override
    protected View inflateFragmentView(LayoutInflater inflater, ViewGroup container) {
        View view = inflater.inflate(R.layout.fragment_canceled_ride, container, false);
