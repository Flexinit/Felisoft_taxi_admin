...
import com.example.drupp_driver.ui.signup.DriverAccountInfoFragment;
...
public class StartUpActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signInButton = findViewById(R.id.proceed_button);
        edtPhoneNumber = findViewById(R.id.et_input_email);
        ...
        new EasyLocationInit(StartUpActivity.this, TIME_INTERVAL, FASTED_TIME_INTERVAL, true);
    ...
    private void checkToken() {
        String token = SessionManager.getInstance().loadFireBaseToken(this).getFirebaseToken();
    ...
    private void generateToken(boolean doLogin) {
        ...
        FirebaseInstanceId.getInstance().getInstanceId()
                .addOnCompleteListener(task -> {
                    ...
                    SessionManager.getInstance().saveFireBaseToken(this, new FireBaseToken(token, "1"));
                    ...
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (response.code() == 200) {
                            ...
                            try {
                                ...
                                SessionManager.getInstance().saveUserDetails(StartUpActivity.this, userDetails);
                                SessionManager.getInstance().saveUser(StartUpActivity.this, userModel);

                                Intent intent = new Intent(StartUpActivity.this, RideActivity.class);
    ...
    public void getEvent(final Event event) {
        if (event instanceof LocationEvent) {
            if (((LocationEvent) event).location != null) {
                ...
                userLocation.setCurrentLatLng(new LatLng(((LocationEvent) event).location.getLatitude(), ((LocationEvent) event).location.getLongitude()));
                SessionManager.getInstance().saveUserLocation(StartUpActivity.this, userLocation);
            }
        }
    }
}
