...
public class DriverScheduledRidesAdapter extends RecyclerView.Adapter<DriverScheduledRidesAdapter.DriverScheduledRidesHolder> {
    ...
    public DriverScheduledRidesAdapter(Context context, ArrayList<ScheduleRideDriverResponse> scheduleList){
    ...
    public void setItems(ArrayList<ScheduleRideDriverResponse> scheduleList){
        scheduleList.clear();
        this.scheduleList=scheduleList;
        getAllDriverModels();
    ...
    @NonNull
    @Override
    public DriverScheduledRidesHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DriverScheduledRidesHolder holder, int position) {
    ...
    public class DriverScheduledRidesHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
           /* Intent intent = new Intent(context, TripHistoryMid.class);
            ...
            scheduledRideDetailDialog.show(((ScheduledRidesActivity)context).getSupportFragmentManager(),ScheduledRideDetailDialogDriver.class.getSimpleName());
